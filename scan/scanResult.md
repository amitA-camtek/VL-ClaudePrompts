...
- **"scan-result-before"** - Raw scan data with configuration files and source images
- **"scan-result-after"** - Processed results with classification data and exported metadata
...
```
scan/
├── scan-result-after/                             [PROCESSED RESULTS]
...
│
└── scan-result-before/                            [RAW SCAN DATA]
    └── MTK-AHJ11236/
        └── setup1/
            └── lot/
...
**Location:** `images/lot_01/` and `images/lot_02/` in "scan-result-after"
...
**Raw Images:** Raw .jpeg files also exist in "scan-result-before" lot folders with identical naming and quantities.
